...
# This function creates two lists, refinedlist and garbagelist. If the sentence it is processing does not meet certain requirements it is put on the garbagelist.
